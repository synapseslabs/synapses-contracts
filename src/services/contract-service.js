//import ClaimHolderRegisteredContract from './../../build/contracts/ClaimHolderRegistered.json'
//import ClaimHolderPresignedContract from './../../build/contracts/ClaimHolderPresigned.json'
//import ClaimHolderLibrary from './../../build/contracts/ClaimHolderLibrary.json'
//import KeyHolderLibrary from './../../build/contracts/KeyHolderLibrary.json'
import PurchaseLibrary from './../../build/contracts/PurchaseLibrary.json'
import PublicationsRegistryContract from './../../build/contracts/PublicationsRegistry.json'
import PublicationsRegistryStorageContract from './../../build/contracts/PublicationsRegistryStorage.json'
import PublicationContract from './../../build/contracts/Publication.json'
import UnitPublicationContract from './../../build/contracts/UnitPublication.json'
import FractionalPublicationContract from './../../build/contracts/FractionalPublication.json'
...
//import OriginIdentityContract from './../../build/contracts/OriginIdentity.json'
...
class ContractService {
  constructor(options = {}) {
    ...
    const contracts = {
      ...
      publicationsRegistryContract: PublicationsRegistryContract,
      publicationsRegistryStorageContract: PublicationsRegistryStorageContract,
...
//    this.libraries.KeyHolderLibrary = KeyHolderLibrary
  ...
  getBytes32FromIpfsHash(ipfsPublication) {
    return (
      '0x' +
      bs58
        .decode(ipfsPublication)
        .slice(2)
        .toString('hex')
    )
  }
